...
model = YOLO("/deeplearning_team/ydong/dongying/projects/monocular_3d_object_detection/ultralytics/runs/detect/train11/weights/best.pt")  # build a new model from scratch
...
results = model.val(data="minieye-driving-2d.yaml")  # train the model